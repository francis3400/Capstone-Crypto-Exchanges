...
test('Array of exchanges added tothe state', () => {
  const previousState = [];
  const action = {
    type: 'Exchange/Exchange/FETCH_ALL_EXCHANGES/fulfilled',
    payload: [{ id: 1, name: 'Binance', trust_score_rank: 1 }],
  };
...
describe('shoud dispatch get all exchanges action', () => {
  it('should pass', async () => {
    ...
    const exchanges = {
      data: {
        data: [{ exchangeId: 'binance', name: 'Binance', trust_score_rank: 1 }],
      },
    };
